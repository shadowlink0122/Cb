...
void test_enum_typedef_basic() {
    run_cb_test_with_output("../../tests/cases/typedef/test_enum_typedef_basic.cb", 
    ...
    integration_test_passed("test_enum_typedef_basic", "test_enum_typedef_basic.cb");
}

void test_enum_typedef_separated() {
    run_cb_test_with_output("../../tests/cases/typedef/test_enum_typedef_separated.cb", 
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed("test_enum_typedef_separated", "test_enum_typedef_separated.cb");
}

void test_enum_typedef_functions() {
    run_cb_test_with_output("../../tests/cases/typedef/test_enum_typedef_functions.cb", 
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed("test_enum_typedef_functions", "test_enum_typedef_functions.cb");
}

void test_enum_typedef_comprehensive() {
    run_cb_test_with_output("../../tests/cases/typedef/test_enum_typedef_comprehensive.cb", 
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed("test_enum_typedef_comprehensive", "test_enum_typedef_comprehensive.cb");
}
