...
void test_struct_typedef_separated() {
    run_cb_test_with_output_and_time_auto("../../tests/cases/typedef/test_struct_typedef_separated.cb", 
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("test_struct_typedef_separated", "test_struct_typedef_separated.cb");
}

void test_struct_typedef_literals() {
    run_cb_test_with_output_and_time_auto("../../tests/cases/typedef/test_struct_typedef_literals.cb", 
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("test_struct_typedef_literals", "test_struct_typedef_literals.cb");
}

void test_struct_typedef_functions() {
    run_cb_test_with_output_and_time_auto("../../tests/cases/typedef/test_struct_typedef_functions.cb", 
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("test_struct_typedef_functions", "test_struct_typedef_functions.cb");
}

void test_struct_typedef_comprehensive() {
    run_cb_test_with_output_and_time_auto("../../tests/cases/typedef/test_struct_typedef_comprehensive.cb", 
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("test_struct_typedef_comprehensive", "test_struct_typedef_comprehensive.cb");
}
