...
inline void test_array_copy() {
    ...
    // 基本的な配列コピー（手動）
    run_cb_test_with_output_and_time_auto(test_file_basic_copy,
    ...
    integration_test_passed_with_time_auto("array basic copy", test_file_basic_copy);
    
    // 多次元配列リテラル
    run_cb_test_with_output_and_time_auto(test_file_multidim,
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("multidimensional array literal", test_file_multidim);
    ...
    integration_test_passed_with_time_auto("all types 1D arrays", test_file_all_types);
    
    // 2次元数値配列
    run_cb_test_with_output_and_time_auto(test_file_multidim_numeric,
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("multidimensional numeric arrays", test_file_multidim_numeric);
    
    // 3次元配列
    run_cb_test_with_output_and_time_auto(test_file_cube_3d,
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("3D cube array", test_file_cube_3d);
    
    // 手動配列コピー
    run_cb_test_with_output_and_time_auto(test_file_manual_copy,
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("manual array copy", test_file_manual_copy);
    
    // === 追加の詳細テスト ===
    
    // 配列型互換性テスト
    const std::string test_file_type_compatibility = "../../tests/cases/array_copy/type_compatibility.cb";
    run_cb_test_with_output_and_time_auto(test_file_type_compatibility,
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("array type compatibility", test_file_type_compatibility);
    
    // 混合次元配列テスト
    const std::string test_file_mixed_dimensions = "../../tests/cases/array_copy/mixed_dimensions.cb";
    run_cb_test_with_output_and_time_auto(test_file_mixed_dimensions,
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("mixed dimensions array copy", test_file_mixed_dimensions);
    
    // 文字列配列高度テスト（スキップ：配列初期化の問題により）
    // const std::string test_file_string_advanced = "../../tests/cases/array_copy/string_advanced.cb";
    // run_cb_test_with_output_and_time_auto(test_file_string_advanced,
    //     [](const std::string& output, int exit_code) {
    ...
    //     });
    // integration_test_passed_with_time_auto("string array advanced", test_file_string_advanced);
    
    // bool配列テスト
    const std::string test_file_bool_arrays = "../../tests/cases/array_copy/bool_arrays.cb";
    run_cb_test_with_output_and_time_auto(test_file_bool_arrays,
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("bool array operations", test_file_bool_arrays);
    
    // 数値型範囲テスト
    const std::string test_file_numeric_ranges = "../../tests/cases/array_copy/numeric_ranges.cb";
    run_cb_test_with_output_and_time_auto(test_file_numeric_ranges,
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("numeric ranges in arrays", test_file_numeric_ranges);
}
