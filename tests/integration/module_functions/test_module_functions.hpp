...
void test_module_functions_basic() {
    run_cb_test_with_output("../../tests/cases/module_functions/test_module_functions.cb", 
    ...
    integration_test_passed("test_module_functions_basic", "test_module_functions.cb");
}

void test_module_functions_simple() {
    run_cb_test_with_output("../../tests/cases/module_functions/test_simple_module_functions.cb", 
        [](const std::string& output, int exit_code) {
            std::cout << "[integration] module_functions simple test executed with exit_code: " 
                      << exit_code << std::endl;
        });
    integration_test_passed("test_module_functions_simple", "test_simple_module_functions.cb");
}
