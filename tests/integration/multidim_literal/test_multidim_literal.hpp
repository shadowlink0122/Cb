...
void test_multidim_literal() {
    ...
    // 実用的なN次元配列リテラルテスト
    run_cb_test_with_output("../../tests/cases/multidim_literal/practical_ndim.cb", 
    ...
    integration_test_passed("test_practical_ndim_literal", "../../tests/cases/multidim_literal/practical_ndim.cb");
    
    // 文字列多次元配列リテラルテスト
    run_cb_test_with_output("../../tests/cases/multidim_literal/string_multidim.cb", 
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed("test_string_multidim_literal", "../../tests/cases/multidim_literal/string_multidim.cb");
    
    // 非対称多次元配列テスト
    run_cb_test_with_output("../../tests/cases/multidim_literal/asymmetric.cb", 
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed("test_asymmetric_multidim_literal", "../../tests/cases/multidim_literal/asymmetric.cb");
    
    // 3次元配列総合テスト
    run_cb_test_with_output("../../tests/cases/multidim_literal/ndim_comprehensive.cb", 
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed("test_ndim_comprehensive", "../../tests/cases/multidim_literal/ndim_comprehensive.cb");
    
    // 4次元・5次元配列テスト
    run_cb_test_with_output("../../tests/cases/multidim_literal/4d_5d_test.cb", 
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed("test_4d_5d_arrays", "../../tests/cases/multidim_literal/4d_5d_test.cb");
    
    // 高次元配列テスト（10次元・6次元）
    run_cb_test_with_output("../../tests/cases/multidim_literal/high_dim_test.cb", 
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed("test_high_dimension_arrays", "../../tests/cases/multidim_literal/high_dim_test.cb");
