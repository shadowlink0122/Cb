...
inline void test_integration_const_variables() {
    ...
    run_cb_test_with_output(test_file_string_reassign, 
    ...
    integration_test_passed("const string reassign error test", test_file_string_reassign);
    ...
    integration_test_passed("const variables read ok test", test_file_read_ok);
}
