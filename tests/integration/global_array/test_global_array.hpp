...
void test_global_array_basic() {
    run_cb_test_with_output_and_time_auto("../../tests/cases/global_array/basic.cb",
    ...
    integration_test_passed_with_time_auto("global array basic test", "basic.cb");
}

void test_global_array_types() {
    run_cb_test_with_output_and_time_auto("../../tests/cases/global_array/types.cb",
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("global array types test", "types.cb");
}

void test_global_array_function_access() {
    run_cb_test_with_output_and_time_auto("../../tests/cases/global_array/function_access.cb",
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("global array function access test", "function_access.cb");
}
