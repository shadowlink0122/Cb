...
void test_multiple_variable_declaration() {
    run_cb_test_with_output_and_time_auto("../../tests/cases/multiple_var_decl/multiple_var_decl.cb", 
    ...
    integration_test_passed_with_time_auto("test_multiple_variable_declaration", "multiple_var_decl.cb");
}
...
inline void test_integration_multiple_var_decl() {
    ...
    // 新規追加のテスト群
    run_cb_test_with_output_and_time_auto("../../tests/cases/multiple_var_decl/multiple_var_init_basic.cb", 
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("test_multiple_var_init_basic", "multiple_var_init_basic.cb");
    
    run_cb_test_with_output_and_time_auto("../../tests/cases/multiple_var_decl/multiple_var_init_string.cb", 
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("test_multiple_var_init_string", "multiple_var_init_string.cb");
    
    run_cb_test_with_output_and_time_auto("../../tests/cases/multiple_var_decl/multiple_var_init_mixed.cb", 
        [](const std::string& output, int exit_code) {
    ...
    integration_test_passed_with_time_auto("test_multiple_var_init_mixed", "multiple_var_init_mixed.cb");
    
    run_cb_test_with_output_and_time_auto("../../tests/cases/multiple_var_decl/multiple_var_init_expressions.cb", 
        [](const std::string& output, int exit_code) {
