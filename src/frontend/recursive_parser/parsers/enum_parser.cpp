...
EnumParser::EnumParser(RecursiveParser* parser) 
    : parser_(parser) {}
...
ASTNode* EnumParser::parseEnumDeclaration() {
    ...
    parser_->consume(TokenType::TOK_SEMICOLON, "Expected ';' after enum declaration");
...
ASTNode* EnumParser::parseEnumTypedefDeclaration() {
    ...
    parser_->consume(TokenType::TOK_LBRACE, "Expected '{' after 'typedef enum'");
    ...
    parser_->consume(TokenType::TOK_SEMICOLON, "Expected ';' after typedef enum declaration");
