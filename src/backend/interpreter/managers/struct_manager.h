...
class StructManager {
  public:
    ...
    void
    create_struct_member_variables_recursively(const std::string &base_path,
                                               const std::string &struct_type,
                                               bool is_global);
    ...
    void assign_struct_member(const std::string &var_name,
                              const std::string &member_path, int64_t value);
    ...
    void assign_struct_member(const std::string &var_name,
                              const std::string &member_path, double value);
    ...
    int64_t get_struct_member_multidim_array_element(
        const std::string &var_name, const std::string &member_path,
