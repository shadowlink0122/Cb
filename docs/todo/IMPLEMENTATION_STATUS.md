...
## 🔮 v0.14.0~v0.15.0 将来の機能

### v0.14.0: Error Handling
- [ ] RuntimeError列挙型
- [ ] try式
- [ ] checked式
- [ ] panic/unwrap

### v0.15.0: Advanced Features
- [ ] Async関数型サポート
- [ ] Asyncラムダ式
...
### 計画中の機能
- `docs/features/v0.15.0_untested_behaviors.md` - 未実装・未確認機能
- `docs/todo/v0.15.0_generic_array_support.md` - ジェネリクス配列サポート
- `docs/todo/v0.15.0_implementation_plan.md` - v0.15.0実装計画
