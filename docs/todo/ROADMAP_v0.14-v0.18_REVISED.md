# Cb言語開発ロードマップ v0.14.0 - v0.18.0 改訂版
...
このドキュメントは、Cb言語の次期5つのメジャーバージョン（v0.14.0〜v0.18.0）の実装計画をまとめた改訂版です。旧ロードマップから以下の重要な変更を加えました：

### 🔄 主な変更点

1. **v0.15.0の削除**: 旧v0.15.0（内容が v0.14.0 と重複）を削除
2. **v0.15.0の新設**: 旧v0.16.0のIR部分を前倒して新v0.15.0として実装
3. **v0.16.0の再構成**: バックエンド実装 + v0.17.0準備機能
4. **v0.17.0の明確化**: 標準ライブラリの完全ライブラリ化（組み込み関数ゼロ）
5. **v0.18.0の維持**: パッケージエコシステム（変更なし）

### 🎯 各バージョンの目標

| バージョン | 期間 | 主要目標 |
|-----------|------|---------|
| **v0.14.0** | 2-3ヶ月 | テストカバレッジ改善＋Async機能拡張 |
| **v0.15.0** | 3-4ヶ月 | IR基盤実装（HIR/MIR/LIR）🆕 |
| **v0.16.0** | 3-4ヶ月 | 複数バックエンド＋v0.17.0準備機能 |
| **v0.17.0** | 2-3ヶ月 | 標準ライブラリ化（組み込み関数ゼロ） |
...
```
Month 1-3:   v0.14.0 - テストカバレッジ改善＋Async機能拡張
Month 4-7:   v0.15.0 - IR基盤とコンパイラ最適化
Month 8-11:  v0.16.0 - 複数バックエンド対応＋v0.17.0準備機能
Month 12-14: v0.17.0 - 標準ライブラリの完全ライブラリ化
Month 15-17: v0.18.0 - パッケージエコシステム
```

---

## 🎯 v0.14.0: テストカバレッジ改善とAsync機能拡張（2-3ヶ月）
...
## 🎯 v0.15.0: IR基盤とコンパイラ最適化（3-4ヶ月）🆕

### 概要

**注**: 旧v0.16.0のIR部分を前倒して実装
...
### 詳細ドキュメント
- [`docs/todo/v0.15.0/README.md`](./v0.15.0/README.md)

---

## 🎯 v0.16.0: 複数バックエンド対応＋v0.17.0準備機能（3-4ヶ月）

### 概要

複数バックエンド（Native/WASM/TypeScript）を実装し、**v0.17.0での標準ライブラリ完全ライブラリ化のための必須機能**を実装します。
...
- [ ] 条件付きコンパイル完全実装
- [ ] モジュールシステム強化完了
- [ ] **v0.17.0で標準ライブラリをライブラリ化できる状態** 🎯

### 詳細ドキュメント
- [`docs/todo/v0.16.0/v0.16.0_revised_roadmap.md`](./v0.16.0/v0.16.0_revised_roadmap.md)

---

## 🎯 v0.17.0: 標準ライブラリの完全ライブラリ化（2-3ヶ月）
...
### 詳細ドキュメント
- [`docs/todo/v0.17.0/v0.17.0_stdlib_library_complete.md`](./v0.17.0/v0.17.0_stdlib_library_complete.md)
...
### 詳細ドキュメント
- [`docs/todo/v0.18.0/README.md`](./v0.18.0/README.md)
...
| v0.17.0準備機能の遅延 | 高 | v0.16.0で最優先実装 |
...
1. **v0.15.0の新設**: IR実装を前倒し、コンパイラ基盤を早期構築
2. **v0.16.0の強化**: v0.17.0準備機能を追加、段階的な実装を実現
3. **v0.17.0の明確化**: 組み込み関数ゼロという明確な目標
